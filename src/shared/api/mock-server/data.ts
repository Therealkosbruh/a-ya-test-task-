    ...
    colors: [
      {
        id: 1,
        name: "черный",
        images: ["/images/3/black_front.png", "/images/3/black_detail.png"],
        price: "249.00",
      ...
      },
      {
        id: 2,
        name: "бежевый",
        images: ["/images/3/beige_front.png"],
        price: "239.00",
    ...
    colors: [
      {
        id: 1,
        name: "черный",
        images: ["/images/6/black_front.png", "/images/6/black_back.png"],
        price: "499.00",
      ...
      },
      {
        id: 2,
        name: "графит",
        images: ["/images/6/graphite_front.png", "/images/6/graphite_back.png"],
        price: "519.00",
